...
\section{Step 3: Our Proposed Mathematical Model (Unsupervised Skill Profiling)}
Because our data provides a single "snapshot" of exam scores (cross-sectional) and does not tell us what jobs the students actually got in the real world, we cannot use traditional supervised prediction. Instead, we propose our own custom mathematical model based on \textbf{Unsupervised Learning}. This allows the algorithm to discover latent skill profiles mathematically.
