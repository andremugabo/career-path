...
* *Note: All raw data files, including *.csv and *.xlsx files, as well as the final 800,000+ row `cleaned_skill_profiles.csv`, are excluded via `.gitignore` to prevent repository bloat.*
